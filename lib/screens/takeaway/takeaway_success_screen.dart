...
/// Celebration overlay displayed after placing a takeaway order.
/// Shows animated green checkmark with confetti and the order ID.
class TakeawaySuccessScreen extends StatefulWidget {
  const TakeawaySuccessScreen({super.key});

  @override
  State<TakeawaySuccessScreen> createState() => _TakeawaySuccessScreenState();
}

class _TakeawaySuccessScreenState extends State<TakeawaySuccessScreen>
  ...
  Widget build(BuildContext context) {
    final latestOrder = TakeawayController.instance.orders.isNotEmpty
        ? TakeawayController.instance.orders.first
        : null;
